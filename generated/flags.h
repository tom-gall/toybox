...
// cpio   (no-preserve-owner)mduH:p:|i|t|F:v(verbose)o|[!pio][!pot][!pF]
#undef OPTSTR_cpio
...
// grep   C#B#A#ZzEFHabhinorsvwclqe*f*m#x[!wx][!EFw]
#undef OPTSTR_grep
#define OPTSTR_grep  0 
#ifdef CLEANUP_grep
#undef CLEANUP_grep
#undef FOR_grep
#undef FLAG_x
...
// ls   (color):;ZgoACFHLRSabcdfhiklmnpqrstux1[-Cxm1][-Cxml][-Cxmo][-Cxmg][-cu][-ftS][-HL][!qb]
#undef OPTSTR_ls
#define OPTSTR_ls  0 
#ifdef CLEANUP_ls
#undef CLEANUP_ls
...
// runcon   <2
#undef OPTSTR_runcon
#define OPTSTR_runcon  0 
#ifdef CLEANUP_runcon
#undef CLEANUP_runcon
#undef FOR_runcon
#endif

// sed   (version)e*f*inEr[+Er]
#undef OPTSTR_sed
#define OPTSTR_sed  0 
#ifdef CLEANUP_sed
#undef CLEANUP_sed
...
// split   >2a#<1=2>9b#<1l#<1
#undef OPTSTR_split
#define OPTSTR_split  0 
#ifdef CLEANUP_split
#undef CLEANUP_split
#undef FOR_split
#undef FLAG_l
...
// top   >0mO*Hk*o*p*u*s#<1d#=3<1n#<1bq[!oO]
#undef OPTSTR_top
#define OPTSTR_top  0 
#ifdef CLEANUP_top
#undef CLEANUP_top
...
// xargs   ^I:E:L#ptxrn#<1s#0
#undef OPTSTR_xargs
#define OPTSTR_xargs  0 
#ifdef CLEANUP_xargs
#undef CLEANUP_xargs
#undef FOR_xargs
#undef FLAG_0
...
#define FLAG_color (FORCED_FLAG<<29)
#endif
